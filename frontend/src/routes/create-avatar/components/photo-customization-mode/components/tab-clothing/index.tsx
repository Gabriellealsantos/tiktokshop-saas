...
import { Sparkles, Upload, Check, Image as ImageIcon, Library, X } from "lucide-react";
import { cn } from "@/utils/utils";
import { Button, Textarea, FormField, FormItem, FormLabel, FormControl, FormMessage } from "@/components";
import type { AvatarPhotoFormValues } from "../../schema";

export function TabRoupa({ form }: { form: UseFormReturn<AvatarPhotoFormValues> }) {
