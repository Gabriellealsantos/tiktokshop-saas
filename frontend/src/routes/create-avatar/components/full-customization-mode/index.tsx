...
export const avatarSchema = z.object({
  ...
  boca: z.enum(["Lábios finos", "Lábios médios", "Lábios carnudos", "Arco do cupido", "Boca larga", "Boca pequena"], { required_error: "Selecione a boca." }),
  sobrancelha: z.enum(["Reta", "Arqueada", "Angulosa", "Grossa / cheia", "Fina", "Curvada suave"], { required_error: "Selecione a sobrancelha." }),
