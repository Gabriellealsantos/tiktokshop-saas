...
import { Field, Toggle } from "@/components/base/form-controls";
import { useMockSession, UserRole, UserStatus, UserPlan } from "@/lib/mock-session";
...
export function ProfileScreen() {
  const { user, credits, updateUser, logout, notificationsEnabled, setNotificationsEnabled } =
    useMockSession();
