    ...
    <div className="flex flex-col gap-3">
      ...
      {!avatarSelecionado ? (
        ...
        >
          ...
          <span className="font-semibold text-white/90 group-hover:text-white transition-colors text-lg mb-2">
            Selecionar avatar
          </span>
          <span className="text-sm text-white/40">
            Clique para escolher quem apresentará o vídeo
          </span>
        </button>
      ) : (
        <div className="group relative overflow-hidden rounded-[20px] bg-surface-3 border border-white/10 aspect-[9/16]">
          ...
          <div className="absolute inset-0 bg-linear-to-t from-black/90 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-5 gap-2.5">
            <Button
              variant="secondary"
              className="w-full bg-white/10 hover:bg-white/20 text-white border border-white/10 backdrop-blur-md h-10"
