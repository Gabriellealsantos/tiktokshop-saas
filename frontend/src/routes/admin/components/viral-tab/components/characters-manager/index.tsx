    ...
    <div className="space-y-4 entrance">
      ...
      {loading ? (
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {items.map((item) => (
            <div key={item.id} className="glass-premium-purple relative overflow-hidden flex items-center gap-4 rounded-2xl border border-white/10 p-3 transition-all duration-200 hover:border-white/20 shadow-lg">
