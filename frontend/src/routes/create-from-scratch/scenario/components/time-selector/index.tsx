...
interface TimeSelectorProps {
  ...
  setTimeOfDaySelected: (id: string) => void;
}

export function TimeSelector({ timeOfDaySelected, setTimeOfDaySelected }: TimeSelectorProps) {
  return (
    <div className="mb-10">
        ...
        {HORARIOS.map((horario) => {
          ...
          return (
            ...
            >
              ...
              <div className={cn("absolute inset-0 opacity-60 group-hover:opacity-80 transition-opacity duration-500 bg-linear-to-br", horario.gradient)} />
              ...
              <div className="relative z-10 flex flex-1 items-center justify-center w-full pt-4">
                <Icon className={cn("size-7 transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-1", horario.iconColor)} />
              </div>
