...
import { ATMOSFERA } from "../../data";

interface AtmosphereSelectorProps {
  atmosphereSelected: string | null;
  setAtmosphereSelected: (id: string) => void;
}

export function AtmosphereSelector({ atmosphereSelected, setAtmosphereSelected }: AtmosphereSelectorProps) {
  return (
    <div className="mb-10">
