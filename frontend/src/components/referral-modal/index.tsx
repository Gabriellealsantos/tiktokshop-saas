            ...
            {step === 2 && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <div className="flex flex-col items-center text-center gap-1.5 p-3 rounded-xl bg-white/[0.03] border border-white/5">
                    <div className="grid size-9 shrink-0 place-items-center rounded-lg bg-brand-500/15 border border-brand-500/30 text-brand-400">
                      <Tag className="size-4" />
                    </div>
                    <div>
                      <p className="text-sm font-bold text-white mb-0.5">50% OFF</p>
                      <p className="text-[11px] text-zinc-400 leading-tight">Metade do preço no mensal ou vitalício.</p>
                    </div>
                  </div>
                  <div className="flex flex-col items-center text-center gap-1.5 p-3 rounded-xl bg-white/[0.03] border border-white/5">
                    <div className="grid size-9 shrink-0 place-items-center rounded-lg bg-brand-500/15 border border-brand-500/30 text-brand-400">
                    ...
                    <div>
                      <p className="text-sm font-bold text-white mb-0.5">Funcionalidades liberadas</p>
                      <p className="text-[11px] text-zinc-400 leading-tight">Todas as funcionalidades da ferramenta liberadas.</p>
                    </div>
                  </div>
                  <div className="flex flex-col items-center text-center gap-1.5 p-3 rounded-xl bg-white/[0.03] border border-white/5">
                    <div className="grid size-9 shrink-0 place-items-center rounded-lg bg-brand-500/15 border border-brand-500/30 text-brand-400">
                    ...
                    <div>
                      <p className="text-sm font-bold text-white mb-0.5">Promoção oficial</p>
                      <p className="text-[11px] text-zinc-400 leading-tight">Desconto e benefícios automáticos no checkout.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 mt-2">
                  ...
                  {/* Vitalício (Featured) */}
                  <div className="relative p-4 rounded-2xl border border-amber-500/50 bg-[linear-gradient(135deg,rgba(245,158,11,0.15)_0%,rgba(0,0,0,0.2)_100%)] shadow-[0_0_15px_rgba(245,158,11,0.1)] flex flex-col justify-center">
                    <div className="absolute -top-2.5 left-1/2 -translate-x-1/2 bg-gradient-to-r from-amber-600 to-amber-500 text-white text-[9px] font-extrabold uppercase tracking-widest px-2 py-0.5 rounded-full shadow-lg whitespace-nowrap">
                      Mais Popular
                    </div>
                ...
                <div className="mt-1 text-center">
                  <Button
                    ...
                    className="w-full rounded-xl bg-gradient-to-r from-brand-600 to-brand-500 hover:from-brand-500 hover:to-brand-400 shadow-[0_0_15px_rgba(var(--color-brand-500),0.2)] hover:shadow-[0_0_20px_rgba(var(--color-brand-500),0.4)] transition-all font-bold h-12 relative overflow-hidden"
                  >
                    {isGenerating ? (
