            ...
            >
              <motion.div
                ...
                className={cn(
                  ...
                  isCurrent &&
                    "bg-accent-500/80 backdrop-blur-[14px] border border-accent-400/55 shadow-[0_0_22px_-4px_rgba(109,91,245,0.6),inset_0_1px_0_rgba(255,255,255,0.18)]",
                  isCompleted &&
              ...
              >
                <span
                  className={cn(
                    ...
                    isCurrent && "bg-white text-accent-500",
