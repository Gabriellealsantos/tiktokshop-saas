...
import { Dialog, DialogContent, DialogDescription, DialogTitle, Pill } from "@/components";
      ...
      >
        ...
        <div className="flex flex-col md:flex-row h-full max-h-[90dvh] md:max-h-[85vh]">
              ...
              <button
                onClick={() => {
                  ...
                  navigate({
                    ...
                    search: (prev: { avatarId?: string | number; applicationMode?: string }) => ({
                      ...prev,
                      productId: product.id,
                      avatarId: prev.avatarId,
                      applicationMode: prev.applicationMode,
                    }),
                  });
                }}
          ...
          <div className="flex flex-col w-full md:w-[56%] p-6 md:p-8 overflow-y-auto bg-surface-1">
            ...
            <ContentGenerationOptions product={product} onNavigate={() => onOpenChange(false)} />
          </div>
        </div>
      </DialogContent>
    </Dialog>
