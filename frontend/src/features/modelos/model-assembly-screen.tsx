...
export function ModelAssemblyScreen() {
                ...
                <div className="group relative overflow-hidden rounded-[20px] bg-gradient-to-br from-surface-3 to-deep border border-white/5 aspect-[9/16] flex flex-col items-center justify-center">
                  {videoUrl ? (
                    <>
                      ...
                      <div className="hidden absolute inset-0 bg-gradient-to-br from-violet-500/10 to-fuchsia-500/10 flex flex-col items-center justify-center text-white/30 gap-4">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-violet-500/10 to-fuchsia-500/10 flex flex-col items-center justify-center text-white/30 gap-4">
                      <div className="size-16 rounded-full bg-white/5 flex items-center justify-center backdrop-blur-md border border-white/10">
                        <Play className="size-6 ml-1" />
                      </div>
