                ...
                <div className="space-y-1">
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="h-12 w-full rounded-xl border border-white/10 bg-white/5 pl-10 focus-visible:border-violet-500 focus-visible:ring-1 focus-visible:ring-violet-500"
                    />
                  </div>
                ...
                <div className="space-y-1">
                  <div className="relative">
                    ...
                    <Input
                      ...
                      placeholder="••••••••"
                      className="h-12 w-full rounded-xl border border-white/10 bg-white/5 px-10 focus-visible:border-violet-500 focus-visible:ring-1 focus-visible:ring-violet-500"
                    />
                    <button
                      type="button"
